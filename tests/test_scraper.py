...
class TestScraper(unittest.TestCase):
    ...
    def test_get_page_content_successful_request(self, mock_session):
        ...
        with patch("src.scraper.Scraper.get_page_content") as mock_get_page_content:
            mock_get_page_content.return_value = "<html></html>"
    ...
    def test_get_movie_data_with_valid_html(self):
        ...
        movie_html.find.side_effect = [
            MagicMock(text="1. Test Movie"),
            MagicMock(text="Meta: 2022"),
